...
//$sql3="select * from employee where id='".$id."' and pmtdt='".$_SESSION['pmtdt']."' and bill_type='".$_SESSION['bill_type']."'";
...
$sql5="update employee set status='Under Consideration' where id='".$id."' and pmtdt='".$_SESSION['pmtdt']."' and bill_type='".$_SESSION['bill_type']."'";
//echo $sql5;
