...
<div id="main_container">
    ...
    <div class="logo"><a href="#"><img src="images/xebia1.png" alt="" title="" border="0" /></a></div>
         ...
         <h4><B>USERNAME AND PASSWORD DOESN'T MATCH. GIVE YOUR CORRECT LOGIN DETAILS HERE.</B></h4>
         <br>		
         ...
         <form action="manager-dashboard.php" method="post" class="niceform">
                ...
                <fieldset>
                    <dl>
                        ...
                        <dd><input type="text" name="username" id="" size="25" /></dd>
                    </dl>
                    <dl>
                        <dt><label for="password">Password:</label></dt>
                        <dd><input type="text" name="passwd" id="" size="25" /></dd>
                    </dl>
